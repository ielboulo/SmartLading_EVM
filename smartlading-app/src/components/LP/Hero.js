...
export default function Hero() {
  ...
  <button
    onClick={() => {/* ajouter votre fonction ici */}}
    className="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-blue-600 bg-white hover:text-white hover:bg-blue-700 md:py-4 md:text-lg md:px-10"
  >
    Learn More
  </button>
</div>
